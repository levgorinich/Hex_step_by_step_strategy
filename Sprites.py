...
class MapObject(pygame.sprite.Sprite):
    ...
    def calculate_coordinate_by_hex_position(self, hex_position,):
        ...
        a = hex_width/2+(hex_width*3/4) * hex_position[0]
        print(a,"a")
        map_coord_x =a
        print(map_coord_x,"coord")
        if hex_position[0] % 2 == 0:
            map_coord_y = hex_height/2 + hex_height * hex_position[1]
        else:
            map_coord_y = hex_height + hex_height * hex_position[1]
        print(hex_position, map_coord_x, map_coord_y, "fun return ")
